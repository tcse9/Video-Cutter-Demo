...
import com.ovi.videocutter.adapter.VideosGridAdapter;
import com.ovi.videocutter.utils.VideoDataSource;
import com.ovi.videocutter.utils.VideoFolder;
import com.ovi.videocutter.utils.VideoItem;
import com.ovi.videocutter.utils.VideoPicker;
 ...
 *
 */
public class VideoGridActivity extends FragmentActivity implements VideoDataSource.OnVideosLoadedListener, VideoPicker.OnVideoSelectedListener,OnClickListener{
...
//			finish();
			...
			if(!isSelect){
				Toast.makeText(VideoGridActivity.this, "您还没有选择任何视频", Toast.LENGTH_SHORT).show();
			}else{
