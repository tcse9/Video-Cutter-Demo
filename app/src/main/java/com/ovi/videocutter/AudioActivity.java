...
import com.ovi.videocutter.adapter.TimeAdapter;
import com.ovi.videocutter.inter.ScrollViewListener;
import com.ovi.videocutter.utils.AudioUtils;
import com.ovi.videocutter.utils.CheapWAV;
import com.ovi.videocutter.utils.DateUtils;
import com.ovi.videocutter.utils.DensityUtil;
import com.ovi.videocutter.utils.IsNonEmptyUtils;
import com.ovi.videocutter.utils.SamplePlayer;
import com.ovi.videocutter.utils.SoundFile;
import com.ovi.videocutter.utils.U;
import com.ovi.videocutter.utils.UserToast;
import com.ovi.videocutter.view.ObservableScrollView;
import com.ovi.videocutter.view.ProgressView_audio;
import com.ovi.videocutter.view.WaveCanvas;
import com.ovi.videocutter.view.WaveSurfaceView;
import com.ovi.videocutter.view.WaveformView;
...
//							File newNameFile_pcm=new File(U.DATA_DIRECTORY+newName+".pcm");
							...
							Toast.makeText(AudioActivity.this, getString(R.string.txt_bw_within_ten_words), Toast.LENGTH_SHORT).show();
						}
						//保存视频录制的总时长
						isEditOrSave=false;
						dismiss();
				...
				ll_upload.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(mFile.exists()&&oldPcm.exists()){
							...
							Toast.makeText(AudioActivity.this, getString(R.string.file_not_exists), Toast.LENGTH_SHORT).show();
						}
						isEditOrSave=true;
						dismiss();
						saveTimeFlag(newName);
     ...
     */
		private void saveRingtone(final String name) {
	        ...
	        mProgressDialog.setTitle(getString(R.string.working));
